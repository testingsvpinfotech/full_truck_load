...
/////////////////////// Loader /////////////////////
    ...
    $('.sidebar-menu .dropdown>a').on('click', function () {
        $(".sidebar .sidebar-menu > li ul li.dropdown").removeClass('active');
            $(".sidebar .sidebar-menu > li ul li.dropdown .sub-menu").slideUp('slow');
...
////////////////////////////// TEMPLATE Color /////////////////////////
    $(".gradient-img-block").on('click', function () {
        ...
        var imageUrl = "assets/admin_assets/dist/images/" + $(this).data('img');
