...
$('.approve_vendor').click(function () {
	...
	swal({
		title: 'Are you sure?',
		text: "You won't Approve this Vendor!",
		icon: 'warning',
		...
		if (result.value) {
			$.ajax({
				url: 'Admin_vendore_registration/vendor_approve',
				type: 'POST',
				data: 'getid=' + getid,
				dataType: 'json'
			})
...
$('.reject_vendor').click(function () {
	...
	swal({
		title: 'Are you sure?',
		text: "You won't reject this Vendor!",
		icon: 'warning',
		showCancelButton: true,
		confirmButtonColor: '#3085d6',
		cancelButtonColor: '#d33',
		...
		if (result.value) {
			$.ajax({
				url: 'Admin_vendore_registration/vendor_reject',
				type: 'POST',
				data: 'getid=' + getid,
				dataType: 'json'
			})
