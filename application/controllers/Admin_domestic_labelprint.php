...
class Admin_domestic_labelprint extends CI_Controller  {
        ...
        $user_type = $this->session->userdata("userType");
            ...
            if ($this->session->userdata("userType") == '1') {
                ...
                //if ($resAct->num_rows() > 0) {
                    ...
                    $data['allpoddata'] = $this->booking_model->get_domestic_all_pod_data($whr,"");
                //}
            } else {
                $where = '';
            ...
            $data['viewVerified'] = 2;
            $this->load->view('admin/Label_print/view_domestic_label_print', $data);
       
    }

    public function domestic_printlabel($prntext){
        // Load library
		...
		$this->load->view('admin/Label_print/domestic_printlabel', $data);
	}
