             ...
             <div class="col-12 mt-3">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">                                           
                                <div class="col-12">
                                <form role="form" action="<?php echo base_url();?>admin/edit-region/<?php echo $rgn->region_id; ?>" method="post" enctype="multipart/form-data">

                                    <div class="form-group row">
                                        <div class="col-4 mb-3">
                                            <label for="username">Zone</label>
                                           <input type="text" class="form-control" name="region_name" placeholder="Zone" value="<?php echo $rgn->region_name; ?>" required>
                                        </div>     
                                        <div class="col-4 mb-3">
                                           <label>State</label>
