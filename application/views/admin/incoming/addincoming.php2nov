   ...
   // include('admin_shared/admin_sidebar.php'); ?>
        ...
        <div class="box-body">
			...
			<form role="form" action="admin/add-incoming" method="post">
				...
				<div class="col-sm-2">
								  <input type="datetime-local" class="form-control" name="datetime" id="exampleInputEmail1" required >
								</div>
							</div>
					<thead>
					<tr>
					...
					<tr>
					  ...
					  <?php 
						...
						{ ?>
							<td id="<?php echo $value->pod_no; ?>"><?php echo ($value->reciving_status > 0)?'Recieved':'';?></td>
