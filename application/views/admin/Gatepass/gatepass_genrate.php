     ...
     <body id="main-container" class="default">
     					...
     					<div class="col-12 col-sm-12 mt-3">
     						<div class="card">
     							<div class="card-header justify-content-between align-items-center">
     								<h4 class="card-title">Genrate Gatepass</h4>
     							</div>
     							<div class="card-body">
     								...
     								<div class="row">
     									<div class="col-12"> <a href="<?= base_url('admin/view-genrated-gatepass'); ?>" class="btn btn-primary">View Genrated Gatepass</a> <br><br>
     										<form role="form" action="<?= base_url(); ?>admin/gatepass" method="post" enctype="multipart/form-data">
												 ...
												 <label class="col-sm-1 col-form-label">Menifest No</label>
     												...
     												<label class="col-sm-1 col-form-label">Bag Scan</label>
     												<div class="col-sm-2">
     										...
     										<form role="form" action="<?= base_url('admin/add-gatepass'); ?>" method="post" enctype="multipart/form-data">
     											<div class="form-group row">
     												...
     												<label class="col-sm-2 col-form-label">Gatepass Genrate Date</label>
     												<div class="col-sm-2">
     												...
     												<div class="col-sm-2">
     													<input type="text" name="driver_name" required  class="form-control" />
     												</div>
     											</div>
     											<div class="form-group row">
		...
		$source_branch		= 	$ress->row()->branch_name; $count = 1; if($result){  foreach ($result as $key=>$value) { ?>
																<tr>
																	<td><?= $count++; ?></td>
