     					...
     					<div class="col-12 col-sm-12 mt-3">
     						<div class="card">
     							<div class="card-header justify-content-between align-items-center">
     								<h4 class="card-title">Gatepass In Scan</h4>
     							</div>
     							<div class="card-body">
     								...
     								<div class="row">
     									<div class="col-12"> <a href="<?= base_url('admin/view-genrated-in-scan'); ?>" class="btn btn-primary">View Gatepass In Scan</a> <br><br>
     													...
     													<tbody>
															<?php $count = 1; if($result){  foreach ($result as $key=>$value) { ?>
																<tr>
																	...
																	<td><?php $whr3 = array('gatepass_no'=>$value->gatepass_no);
		                                                         	$ress = $this->basic_operation_m->getAll('tbl_gatepass', $whr3); $val = $ress->row(); print_r($val->total_no_bag);?></td>
