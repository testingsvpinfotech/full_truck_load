     					...
     					<div class="col-12 col-sm-12 mt-3">
     						<div class="card">
     							<div class="card-header justify-content-between align-items-center">
     								<h4 class="card-title">Genrated Gatepass</h4>
     							</div>
     							<div class="card-body">
     												...
     												<table class="table table-bordered table-striped">
     													...
     													<tbody>
															<?php  $count = 1; if($result){  foreach ($result as $key=>$value) { ?>
																<tr>
																<td><?= $count++; ?></td>
																	<td><?php echo $value->date;?> <input type="hidden" id="custId" name="manifiest_id" value="<?php echo $value->manifiest_id;?>"></td>
																	<td><?php echo $value->bag_no;?></td>
																	<td><?php echo $value->gatepass_no;?></td>
																	<td><?php echo $value->manifiest_id;?></td>
																	<td><?php echo $value->in_scan;?></td>
