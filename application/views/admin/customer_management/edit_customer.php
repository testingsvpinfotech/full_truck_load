                        ...
                        <div class="form-row">
                            ...
                            <div class="col-3 mb-3">
                                    ...
                                    <div class="col-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="panno"  placeholder="Enter Pan No." value="<?php echo $customer->panno;?>">
                                    </div>
                                    <div class="col-3 mb-3">
                             ...
                             <div class="col-3 mb-3">
                              ...
                              <div class="col-3 mb-3">
                                <label for="username">Credit Limit</label>
                                  <input type="number" class="form-control" name="credit_limit" id="credit_limit" value="<?php echo $customer->credit_limit;?>">
                                </div>
                              <div class="col-3 mb-3">
                                  <label for="username">Gst File</label>
                                  <img src="<?= base_url('assets/customer/'.$customer->gstfile); ?>" alt="<?= $customer->gstfile; ?>" width="100px" height="100px">
                              </div> 
                              <div class="col-3 mb-3">
                                  <label for="username">Pan File</label>
                                  <img src="<?= base_url('assets/customer/'.$customer->panfile); ?>" alt="<?= $customer->panfile; ?>" width="100px" height="100px">
                              </div> 
