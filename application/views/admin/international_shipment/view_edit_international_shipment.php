                                               ...
                                               <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                   <label class="col-sm-3 col-form-label">Grand Total</label>
													<div class="col-sm-6">
														<div class="input-group mb-3">
			                                        		<input type="text"  class="form-control" readonly name="grand_total"  id="grand_total" value="<?php if(empty($booking->cgst || $booking->sgst|| $booking->igst)){ echo $booking->sub_total; }else{ echo $booking->grand_total; }?>"/>
														</div>
													</div>
                                                </div>
                                                 <div class="form-group row">
