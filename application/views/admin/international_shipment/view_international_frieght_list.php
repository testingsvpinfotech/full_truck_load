                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">                              
                              <h4 class="card-title">Frieght Invoice</h4>                         
                              <span style="float: right;">
                              <a href="admin/view_international_frieght_invoice" class="btn btn-primary">Add Frieght Invoice</a>
                          </span>
                          </div>
                          <div class="card-body">
  ...
  <?php  unset($_SESSION['class']); unset($_SESSION['notify']); } ?> 
                              <div class="table-responsive">
                                   <table id="example" class="display table dataTable table-striped table-bordered layout-primary" data-sorting="true">
                                      ...
                                      <tbody>
                                 <?php 
                                    if (!empty($f_invoice_details))
									{
										$cnt=0;
										foreach ($f_invoice_details as $value) 
										{
											$cnt++;
											
											$whr = array('customer_id'=>$value['customer_account_id']);
											$cust_details = $this->basic_operation_m->get_table_row('tbl_customers',$whr);
                                    ?>
											<tr class="odd gradeX">		
												<td style="width: 15%;"><?php echo $cnt;?></td>
												<td style="width: 15%;"><?php echo $value['f_invoice_id'];?></td>
												<td style="width: 15%;"><?php echo $value['f_invoice_date'];?></td>
												<td style="width: 15%;"><?php echo $cust_details->customer_name;?></td>
												<td style="width: 15%;"><?php echo $value['grand_total'];?></td>
												
												<td> <a href="admin/view_edit_international_frieght_invoice/<?php echo $value['id'];?>" title="Frieght Invoice" target="_blank" class="btn btn-primary btn-sm">Edit</a>&nbsp; |

													<a href="admin/international-freight_invoice/<?php echo $value['id'];?>"  class="btn btn-primary btn-sm">View Invoice</a>
												</td>
											 </tr>
									<?php 
										$cnt++;
