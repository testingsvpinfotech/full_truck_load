                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">                              
                              <h4 class="card-title">International Unbill Shipment</h4>
                                 ...
                                 <?php 
                                    ...
                                    ?>
											<tr class="odd gradeX">
												...
												<td>
													<!-- <a href="admin/view_edit_international_shipment/<?php echo $value['booking_id'];?>" class="btn btn-primary btn-sm"> -->
