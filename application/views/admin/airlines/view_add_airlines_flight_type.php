                  ...
                  <div class="col-12">
                      ...
                      <div class="card">
                          ...
                          <div class="card-header">                               
                              <h4 class="card-title">Add Airlines Flight Type</h4>
                          </div>
						    <div class="card-content">
                          <div class="card-body">
						   <div class="row">                                           
                            <div class="col-12">
                             <form role="form" action="admin/insertairlinesFlighttype" method="post" >
								<div class="box-body">
									<div class="form-group row">
										<label  class="col-sm-1 col-form-label">ETA:</label>
										<div class="col-sm-2">
											<input type="text" class="form-control" name="type_name" placeholder="Enter Filght Type " required>
										</div>
									
										<div class="col-sm-2">
											<button type="submit"  class="btn btn-primary">Add Airlines Flight Type</button>
										</div>
									</div>
									<!-- /.box-body -->
