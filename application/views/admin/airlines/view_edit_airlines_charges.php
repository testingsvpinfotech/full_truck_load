                  ...
                  <div class="col-12">
                      ...
                      <div class="card">
                          ...
                          <div class="card-header">                               
                              <h4 class="card-title">Edit Airlines Charge</h4>
                          </div>
						    <div class="card-content">
                          <div class="card-body">
						   <div class="row">                                           
                            <div class="col-12">
                             <form role="form" action="admin/updateairlinescharges/<?php echo $charge_info->airline_id; ?>/<?php echo $afc_id; ?>" method="post" >
								<div class="box-body">
										...
										<div class="col-sm-2">
										  ...
										  <option value="All">All</option>
											...
											if(!empty($flight_type))
											{
												...
												{ 		 
												?>
													<option value="<?php echo $rows->type_name; ?>" <?php echo ($charge_info->flight_type == $rows->type_name)?'selected':''; ?>><?php echo $rows->type_name; ?></option>
												<?php 
												}
											}
											else
										 ...
										 <div class="col-sm-2">
										  <input type="date" class="form-control" value="<?php echo $charge_info->effective_date; ?>"   name="effective_date" placeholder="Enter Effective Date" >
										 ...
										 <div class="col-sm-2">
										  <input type="text" class="form-control" value="<?php echo $charge_info->inbound_min_weight; ?>"   name="inbound_min_weight" placeholder="Enter Min Weight" required>
										</div>
										 ...
										 <div class="col-sm-2">
										  <input type="text" class="form-control" value="<?php echo $charge_info->inbound_per_kg_charge; ?>"   name="inbound_per_kg_charge" placeholder="Enter Per KG Charge" required>
										</div>
										 ...
										 <div class="col-sm-2">
										  <input type="text" class="form-control" value="<?php echo $charge_info->inbound_minimum_charge; ?>"   name="inbound_minimum_charge" placeholder="Enter Minimum Charge" required>
										</div>
										 ...
										 <div class="col-sm-2">
										  <input type="text" class="form-control" value="<?php echo $charge_info->outbound_min_weight; ?>"   name="outbound_min_weight" placeholder="Enter Min Weight" required>
										</div>
										 ...
										 <div class="form-group">
										  <input type="text" class="form-control" value="<?php echo $charge_info->outbound_per_kg_charge; ?>"   name="outbound_per_kg_charge" placeholder="Enter Per KG Charge" required>
										</div>
										 ...
										 <div class="col-sm-2">
										  <input type="text" class="form-control" value="<?php echo $charge_info->outbound_minimum_charge; ?>"   name="outbound_minimum_charge" placeholder="Enter Minimum Charge" required>
										</div>
										 ...
										 <div class="col-sm-2">
										  <input type="text" class="form-control" value="<?php echo $charge_info->destination; ?>"   id="search-box"  name="destination" placeholder="Enter Destination Charge" >
