...
/*													<a href="<?php echo base_url();?>generatepod/print_slip/<?php echo $number;?>/<?php echo $serviceType;?>" class="btn btn-info"><i class="fas fa-print"></i></a> */
												...
												<td>
													<a href="admin/view_edit_international_shipment/<?php echo $value['booking_id'];?>" class="btn btn-primary"><i class="icon-pencil"></i></a>
													...
													|
													<a href="admin/delete-international-shipment/<?php echo $value['booking_id'];?>" class="btn btn-danger"><i class="icon-trash"></i></a>
													<?php } ?>
												</td>
											 </tr>
									<?php 
