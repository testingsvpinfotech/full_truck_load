                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">                               
                              ...
                              <span style="float: right;"><a href="admin/add-shipment" class="fa fa-plus btn btn-primary">Add Shipment</a></span>
                          </div>
                          <div class="card-body">
                                  ...
                                  <table class="table layout-primary bordered">
                                      <thead>
                                          <tr>
											    ...
											    <th  scope="col">Forwording No</th>
											    <th  scope="col">Forworder Name</th>
...
/*													<a href="<?php echo base_url();?>generatepod/print_slip/<?php echo $number;?>/<?php echo $serviceType;?>" class="btn btn-info"><i class="fas fa-print"></i></a> */
													?>
												</td>
												...
												<td>
													<a href="admin/edit-shipment/<?php echo $value['booking_id'];?>" class="btn btn-primary"><i class="icon-pencil"></i></a>
													<a href="admin/printpod/<?php echo $value['booking_id'];?>" class="btn btn-info"><i class="fas fa-print"></i></a>
													...
													|
													<a href="admin/delete-shipment/<?php echo $value['booking_id'];?>" class="btn btn-danger"><i class="icon-trash"></i></a>
													<?php } ?>
												</td>
											 </tr>
									<?php 
