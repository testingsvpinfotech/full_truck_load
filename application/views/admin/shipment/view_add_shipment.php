                  ...
                  <div class="col-12">
                      ...
                      <div class="card">
                          ...
                          <div class="card-header">                               
                              <h4 class="card-title">Add Shipment</h4><span style="float: right;"></span>
                          </div>
						    <div class="card-content">
                          <div class="card-body">
						   <div class="row">                                           
                            <div class="col-12">
                             <form role="form" id="generatePOD" action="admin/insertshipment" method="post" >
								<div class="box-body">
								  <input type ="hidden" name="rate" id="rate" />
									...
									<h5 class="col-sm-12 card-title">Shipment Info</h5>
										...
										<div class="col-sm-2">
											<div class="custom-control custom-radio custom-control-inline">
												<input type="radio" onchange="tgl(this.value)"   name="doc_type" class="custom-control-input" id="doc_typee" value="1" required>
												<label class="custom-control-label checkbox-primary outline" for="doc_typee">Non-Doc</label>
											</div>	
											<div class="custom-control custom-radio custom-control-inline">
												<input type="radio" onchange="tgl(this.value)"  name="doc_type" class="custom-control-input" id="doc_type" value="0" required>
									...
									<div class="form-group row">
										...
										<div class="col-sm-2">
											<input type="text" class="form-control" name="reciever_pincode" id="reciever_pincode" placeholder="Enter Pincode" />
										</div>
										...
										<div class="form-group row">
											...
											<label   class="col-sm-1 col-form-label">Contact No.:</label>
											<div class="col-sm-2">
												<input type="text" class="form-control" name="reciever_contact"  placeholder="Enter Contact No" />
											</div>
									...
									<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-sm-3">
												...
												<div class="custom-control custom-radio custom-control-inline">
													<input type="radio" name="dispatch_details" class="custom-control-input" id="credit" value="credit" checked>
										...
										<div class="form-group row">
											...
											<h5 class="col-sm-12 card-title">Charges</h5>
													...
													<div class="col-sm-2">
													<input type="number" name="fov" class="form-control" id="fov">
													</div>
													<label   class="col-sm-1 col-form-label">Pickup Charges</label>
													<div class="col-sm-2">
													<input type="number" name="oda" class="form-control" id="oda">
													</div>
													<label   class="col-sm-1 col-form-label"> Delivery Charges</label>
													<div class="col-sm-2">
													<input type="number" name="to_pay" class="form-control" id="to_pat">
													</div>
												</div>
												<div class="form-group row">
													<label   class="col-sm-1 col-form-label"> Handling Charges</label>
													<div class="col-sm-2">
													<input type="text" name="apmt_delivery" class="form-control" id="apmt_delivery">
													</div>
													<label   class="col-sm-1 col-form-label"> AWB Charges</label>
													<div class="col-sm-2">
													<input type="number" name="dod_daoc" class="form-control" id="dod_doac">
													</div>
