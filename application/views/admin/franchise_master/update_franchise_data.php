                    ...
                    <div class="col-12 col-md-12 mt-3">
                        <div class="card p-4">
                            <div class="card-body">
                                ...
                                <form name="form" action="<?php echo base_url('FranchiseController/update_franchise_data_in/'.$customer->customer_id.'/'.$franchise_data->fid.'/'.$delivery_franchise_data->delivery_franchise_id); ?>" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group  col-md-3 ">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="franchise_relation" class="form-control" value="<?php echo $customer->cid; ?>" placeholder="Enter Relation Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3 ">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="age" class="form-control" value="<?php echo $franchise_data->age; ?>" placeholder="Enter Age">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="form-group col-md-4 ">
                                            ...
                                            <input type="text" autocomplete="nope" name="contact_number" value="<?php echo $customer->phone; ?>" pattern='^\+?\d{0,10}' class="form-control" title="please check Contact Number" placeholder="contact_number">
                                        </div>
                                        <div class="form-group col-md-4 ">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <?php $parent = $this->db->query("SELECT customer_name FROM tbl_customers where parent_cust_id = $customer->parent_cust_id ")->row(); ?>
                                            <input type="text" name="master_franchise_name" value="<?php echo $parent->customer_name; ?>" id="master_franchise_name" class="form-control" placeholder="Enter Master Franchise">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4 ">
                                            ...
                                            <select class="form-control" name="delivery_status" id="is_delivery">
                                    ...
                                    <div id="deliver_yes">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control" name="delivery_rate_group">
                                                    <?php if (!empty($delivery_rate_group)) { ?>
                                                        <option>Select Delivery Rate Group</option>
                                                        <?php foreach ($delivery_rate_group as $value) : ?>
                                                            <option value="<?php echo $value->group_id; ?>"<?php if($value->group_id == $delivery_franchise_data->delivery_rate_group ){echo 'selected'; }?>><?php echo $value->group_name; ?> </option>
                                                        <?php endforeach; ?>
                                                    <?php } ?>
                                                </select>
                                            </div>
...
<br><br>
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control" name="rate_group">
                                                    <?php if (!empty($rate_group)) { ?>
                                                        <option>Select Rate Group</option>
                                                        <?php foreach ($rate_group as $value) : ?>
                                                            <option value="<?php echo $value->group_id;?>"  <?php if($value->group_id == $delivery_franchise_data->rate_group ){echo 'selected'; }?>><?php echo $value->group_name; ?> </option>
                                                        <?php endforeach; ?>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control" name="fule_group">
                                                    <?php if (!empty($fuel_group)) { ?>
                                                        <option>Select Fuel Group</option>
                                                        <?php foreach ($fuel_group as $value) : ?>
                                                            <option value="<?php echo $value->group_id; ?>" <?php if($value->group_id == $delivery_franchise_data->fule_group ){echo 'selected'; }?>><?php echo $value->group_name; ?> </option>
                                                        <?php endforeach; ?>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-row">
                                                <div class="form-group col-md-4 ">
                                                    <label class="control-label">Pin Code</label>
                                                    <input type="text" id="cmppincode" autocomplete="nope" value="<?php echo $franchise_data->cmp_pincode; ?>" name="cmp_pincode" class="form-control" placeholder="Enter Pincode Number" title="Places Check Pincode Number" />
                                    ...
                                    <div class="row">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4 ">
                                                ...
                                                <input type="text" autocomplete="nope" name="cmp_account_number" class="form-control" value="<?php echo $franchise_data->cmp_account_number; ?>" placeholder="Enter Account Number">
                                            </div>
                                            <div class="form-group col-md-4 ">
