                    ...
                    <div class="col-12 col-md-12 mt-3">
                        <div class="card p-4">
                            <div class="card-body">
                                ...
                                <form name="form" action="<?php echo base_url(); ?>FranchiseController/store_franchise_data" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="master_franchise_name" id="master_franchise_name" class="form-control" placeholder="Enter Master Franchise">
