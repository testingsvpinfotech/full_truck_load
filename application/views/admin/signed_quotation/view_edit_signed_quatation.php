                  ...
                  <div class="col-12">
                      ...
                      <div class="card">
                          ...
                          <div class="card-header">                               
                              <h4 class="card-title">Edit Signed Quatation</h4>
                          </div>
						    <div class="card-content">
                          <div class="card-body">
						   <div class="row">                                           
                      <div class="col-12">
                               <form role="form" action="admin/update-signed-quatation/<?php echo $sq_id_info->sq_id; ?>" method="post" enctype="multipart/form-data">
                								  <div class="box-body">                								 
                									
								   <div class="form-group row">
                                      <label for="ac_name" class="col-sm-1 col-form-label">Contact Person </label>
                                      <div class="col-sm-3">
                                        <input type="text" class="form-control" name="contact_person" value="<?php echo $sq_id_info->contact_person; ?>" placeholder="Enter Contact Person" required>
                                      </div>                  
                                 
                                      <label for="ac_name" class="col-sm-1 col-form-label">Contact No </label>
                                      <div class="col-sm-3">
                                        <input type="text" class="form-control" name="contact_no" value="<?php echo $sq_id_info->contact_no; ?>" placeholder="Enter Contact No" required>
                                      </div>                  
                                  </div>
								  <br>
								   <div class="form-group row">
                                      ...
                                      <div class="col-sm-3">
                                        <input type="email" class="form-control" name="email" value="<?php echo $sq_id_info->email; ?>" placeholder="Enter Email" required>
                                      </div>
									<label for="ac_name" class="col-sm-1 col-form-label">Attechment</label>
                                      <div class="col-sm-3">
                                        <input type="file" class="form-control" name="attechment" accept="application/pdf" required>
                                      </div>									  
								   ...
								   <br>
									  <div class="col-md-2">
										  <div class="box-footer">
											<button type="submit"  class="btn btn-primary">Update Quatation</button>
										  </div>
									  </div>
									  <!-- /.box-body -->                								  
									</div>
									<input type="hidden" value="<?php echo $sq_id_info->customer_id; ?>" name="customer_id" >
									<input type="hidden" value="<?php echo $sq_id_info->c_courier_id; ?>" name="c_courier_id" >
									<input type="hidden" value="<?php echo $sq_id_info->applicable_from; ?>" name="applicable_from" >
