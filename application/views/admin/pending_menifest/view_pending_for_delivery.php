               ...
               <div class="col-12 col-sm-12 mt-3">
                 <div class="card">
                   <div class="card-header justify-content-between align-items-center">
                    <?php 
                    if(current_url() == 'https://boxnfreight.in/admin/pending-delivery' ){ ?>
                     <h4 class="card-title">Pending For Delivery </h4>
                     <?php }elseif(current_url() == 'https://boxnfreight.in/admin/out-for-delivery' ){ ?>
