        ...
        <main>
         ...
         Add Home Slider</a></span> -->
          ...
          foreach ($allpoddata as  $value) {
            ...
            $print_string = $value['pod_no'] .'#|#' . $city_sender . '#|#' . $value['country_name'] . '#|#' . $value['mode_dispatch'] . '#|#' . $value['no_of_pack']. '#|#' . $value['reciever_address'];
          ...
          $print_string = rtrim($print_string, '=');
                  ...
                  <td>
                    <a target="_blank" href="<?php echo base_url();?>admin/mics_printlabel/<?php echo $print_string;?>" class="btn btn-primary"><i class="ion-printer"></i></a> 
