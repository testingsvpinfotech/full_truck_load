                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">                               
                              <h4 class="card-title">International GST Report</h4>
                          </div>
                          <div class="card-content">
                                <div class="card-body">
                                <div class="row">                                           
                                    <div class="col-12">
                                    <form role="form" action="admin/list-international-gst-report" method="post" enctype="multipart/form-data">
                                        <div class="form-row">                     
                                                   <div class="col-sm-3">
                                ...
                                <thead>
                                      ...
                                      <tbody>                                 
                                       <tr>
                                        <?php
                                        $i=0;
                                            if (!empty($international_gst_data)) {
                                               foreach ($international_gst_data as $value) {
                                                $i++;
                                              ?>
                                                <td><?php echo $i; ?></td>   
