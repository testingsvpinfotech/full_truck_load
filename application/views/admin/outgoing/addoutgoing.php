                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">
                              <h4 class="card-title">Add Outgoing</h4>  
                          </div>
                          <div class="card-body">
                                <div class="card-body">
						   <div class="row">                                           
                            <div class="col-12">
								<form role="form" action="admin/insert-outgoing" method="post" enctype="multipart/form-data">
								...
								<select class="form-control"  name="manifiest_id" required>
									...
									?>
										<option value="<?php echo $row['manifiest_id'];?>">
