                  ...
                  <div class="col-12">
                      ...
                      <div class="card">
                          ...
                          <div class="card-header">                               
                              <h4 class="card-title">Update Franchise Fuel</h4>
                          </div>
						    <div class="card-content">
                          <div class="card-body">
						   <div class="row">                                           
                           <div class="col-12">
                             <form role="form" action="admin/edit-franchise-fuel/<?php echo $fuel_list->cf_id; ?>" method="post" >
            								  <div class="box-body">	
...
<div class="form-group row">
								   ...
								   <div class="form-group row">
                                      ...
                                      <div class="col-sm-3">
                                          ...
                                          <option value="<?php echo $cc['id']; ?>" <?php echo ($fuel_list->group_id == $cc['id'])?'selected':''; ?> ><?php echo $cc['group_name']; ?></option>
                                         <?php } ?>
                                        </select> 
                                      </div>                  
