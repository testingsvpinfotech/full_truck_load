                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                            <div class="row">                                           
                          <div class="col-12">
                               <form role="form" id="billing-form" name="billing-form" action="<?php echo base_url(); ?>admin/edit-invoice-import/<?php echo $id; ?>" method="post">                                          
                                  <div class="col-12">
                                ...
                                <div class="col-12">
                                  ...
                                  <table class="table table-bordered">                                  
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">CGST <?php echo $gstCharges->cgst; ?>%</td>
                                    ...
                                    <tr>
                                       <?php echo str_repeat("<td></td>", 14);  ?>  
                                        <td colspan="2">SGST <?php echo $gstCharges->sgst; ?>%</td>
                                        <td style="text-align: right">
                                            <input type="text" name="sgst" value="<?php echo $customer->sgst_amount; ?>" class="form-control sgst" /></td>
                                    </tr>
                                    <tr>
                                        <?php echo str_repeat("<td></td>", 14);  ?>  
                                        <td colspan="2">IGST <?php echo $gstCharges->igst; ?>%</td>
                                        <td>
