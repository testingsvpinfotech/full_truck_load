                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div class="table-responsive">
                                ...
                                <a title="Edit" href="<?php base_url();?> admin/show-edit-final-invoice/<?php echo $value['id'];?>/<?php echo $value['customer_id'];?>" class="btn btn-primary"><i class="icon-pencil"></i></a>
                                 <!--  |
                                  <a title="Delete" href="<?php base_url();?>admin/delete-smtp/<?php echo $value['id'];?>" class="btn btn-danger"><i class="icon-trash"></i></a>
 -->
                                  |
                                  <a title="View" href="<?php base_url();?>admin/invoice-view/<?php echo $value['id'];?>/<?php echo $value['company_id'];?>" class="btn btn-success"><i class="icon-eye"></i></a>
                                  |
                                  <?php if($value['inc_num'] >= 100){$inc_num = $value['inc_num'];}else{$inc_num = $value['id'];} ?>
                                  <a title="Download" href="<?php base_url();?>assets/invoice/international/<?php echo str_replace('/','_',$invoice_series);?>_<?php echo $inc_num;?>.pdf" download="<?php echo $invoice_series."_".$inc_num.'.pdf'; ?>" class="btn btn-warning"><i class="ion-arrow-down-c"></i></a>

                                   |
                                  <a title="Print" target="_blank" href="<?php base_url();?>admin/invoice-pdf/<?php echo $value['id'];?>/<?php echo $value['company_id'];?>" class="btn btn-dark"><i class="ion-printer"></i></a>
                                   |
                                  <a title="Download Excel" href="<?php base_url(); ?>admin/international_excel/<?php echo $value['id'];?>/<?php echo $value['company_id'];?>" class="btn btn-success"><i class="ion-ios-grid-view"></i></a>
                                    | 
                                 <a title="Send Mail" href="<?php echo base_url('admin/send-international-invoice-mail/' . $value['id'] . '/' . $value['customer_id']); ?>" onclick="return confirm('Are you sure you want to Send Mail?');" class="btn btn-sm btn-primary"><i class="ion-email"></i></a> 
