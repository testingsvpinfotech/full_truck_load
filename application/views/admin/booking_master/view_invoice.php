                                          ...
                                          $cnt=0;
                                            foreach ($allpoddata as $value) {
                                              $cnt++;
                                                ...
                                                <td>
                                                   <a href="<?php base_url();?>admin/show-edit-invoice/<?php echo $value['id']; ?>/<?php echo $value['customer_id']; ?>" ><i class="ion-edit" style="color:var(--primarycolor);"></i></a> |

                                                    <a href="<?php base_url();?>admin/delete-invoice/<?php echo $value['id']; ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this item?');"><i class="ion-trash-b" style="color:var(--danger)"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
