...
<tr>
  <td>
    ...
    echo $city_details->city;?></span> <span class="two-cal">PIN CODE : <?php echo $value['sender_pincode'];?></span></p>
    <p></span> <span class="two-cal">TEL : <?php echo $value['sender_contactno'];?></span>EMAIL : <?php  $whr_cus = array("customer_id"=>$value['customer_id']);
        $cust_details = $this->basic_operation_m->get_table_row("tbl_customers",$whr_cus);
    echo $cust_details->email;?></p>
  
  </td>
  <td>
     <p><span class="two-cal">COMPANY : <?php echo $value['contactperson_name'];?></span></p>
    <p><?php echo $value['reciever_address'];?></p>
    <!-- <p>ADDRESS 2</p> -->
    <p><span class="two-cal">CITY : <?php 
        $whr_sc = array("id"=>$value['reciever_city']);
        $sender_city_details = $this->basic_operation_m->get_table_row("city",$whr_sc);
    echo $sender_city_details->city;?></span> <span class="two-cal">PIN CODE : <?php echo $value['reciever_pincode'];?></span></p>
    <p><span class="two-cal">TEL : <?php echo $value['reciever_contact'];?></span>EMAIL : <?php echo $value['reciever_email'];?></p>
  </td>
...
<tr>
  ...
  //print_r($length_detail);
      for($de=0;$de<count($length_detail);$de++){
           echo $dimention= "'".$length_detail[$de]."*".$breath_detail[$de]."*".$height_detail[$de]."', ";
      }
