									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<select class="form-control" name="type_shipment">
												...
												<option value="WOODEN BOX" <?php if ($booking->type_shipment == 'WOODEN BOX') {
																				echo "selected";
																			} ?>>Wooden Box</option>
										...
										<div class="col-sm-8">
											<select class="form-control" required name="forworder_name" id="forworder_name">
												...
												if (!empty($courier_company)) {
													foreach ($courier_company as $cc) {
												?>
														<option value='<?php echo $cc['c_company_name']; ?>' data-id="<?php echo $cc['c_company_name']; ?>" <?php if ($booking->courier_company_id == $cc['forworder_name']) {
																																								echo "selected";
																																							} ?>><?php echo $cc['c_company_name']; ?></option>
												<?php
													}
														...
														<tbody id="volumetric_table_row">
															...
															?>
																<tr>
																	...
																	<td class="length_td"><input type="number" step="any" name="length_detail[]" class="form-control length" data-attr="<?php echo ($jd + 1); ?>" id="length<?php echo ($jd + 1); ?>" value="<?php echo $length_detail[$jd]; ?>"></td>
