													...
													<div id="volumetric_table"> 
														<table class="weight-table" >
															...
															<tbody id="volumetric_table_row">
																<tr>
																	<td><input type="number" name="per_box_weight_detail[]" class="form-control per_box_weight valid" data-attr="1" id="per_box_weight1"  aria-invalid="false"></td>
																	<td class="length_td"><input type="number" name="length_detail[]" step="any"  class="form-control length" data-attr="1" id="length1" ></td>
																	<td class="breath_td"><input type="number" name="breath_detail[]" step="any"  class="form-control breath" data-attr="1" id="breath1" ></td>
																	<td class="height_td"><input type="number" name="height_detail[]" step="any"  class="form-control height" data-attr="1" id="height1" ></td>
																	<td class="volumetic_weight_td"><input type="number" name="valumetric_weight_detail[]" step="any"  readonly class="form-control valumetric_weight" data-attr="1" id="valumetric_weight1"></td>

																	<td class="volumetic_weight_td"><input type="number" step="any"  name="valumetric_actual_detail[]" class="form-control valumetric_actual" data-attr="1" id="valumetric_actual1"></td>

																	<td class="volumetic_weight_td"><input type="number" name="valumetric_chageable_detail[]" step="any"  readonly class="form-control valumetric_chageable" data-attr="1" id="valumetric_chageable1"></td>
																</tr>
															</tbody>
															<tfoot>
											...
											<div class="row">                                           
												<div class="col-12">
													<div class="form-group row">
															...
															<div class="col-sm-3">
																<input type="number" name="frieht" class="form-control" value=""  id="frieht"/>
															</div>													
