                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">                               
                              <h4 class="card-title">View Final Invoice</h4>
                          </div>
                          <div class="card-body">
                            <div class="row">                                           
                          <div class="col-12">
                               <form role="form" id="billing-form" name="billing-form" action="<?php echo base_url(); ?>admin/edit-invoice/<?php echo $id; ?>" method="post">                                          
                                  ...
                                  <table class="table">
                                    <tbody>
                                        <tr>
                                          <td><input type="text" name="customer_name" value="<?php echo $customer->customer_name ?>" class="form-control"/>
                                           <textarea name="address" rows="5" class="form-control"/><?php echo $customer->address; ?></textarea>
                                                     ...
                                                     <td>
                                                       <label for="invoice_date" class="col-form-label">Invoice Date</label><br>
                                                        <label for="invoice_date" class="col-form-label">Invoice Number</label>
                                                     </td>
                                                     <td>
                                                    <div>
                                                        <?php
                                                        ...
                                                        ?>
                                                    <input type="text" class="form-control" name="invoice_date" value="<?php echo $invoiceDate; ?>" />
                                  ...
                                  <table class="table layout-primary bordered">                                  
                                      <thead>
                                          <tr>  
                                              ...
                                              <th scope="col">DeliveryCh.</th>
                                              <th scope="col">CourierCh.</th>
                                              <th scope="col">AWBCh.</th>                                              
                                      ...
                                      <?php
                                          ...
                                          <tr id="rowdata_<?php echo $i; ?>">
                                                ...
                                                <td style="width:25px;"><input type="text" id="mode_dispatch_<?php echo $i; ?>" value="<?php echo $value['mode_dispatch']; ?>" class="form-control" style="width:60px;"/></td>
                                    ...
                                    ?>
                                     <tr><?php echo str_repeat("<td></td>", 13);  ?>                                      
