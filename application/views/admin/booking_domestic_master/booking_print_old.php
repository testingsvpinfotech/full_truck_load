                             ...
                             <div class="row">
                                ...
                                <div class="col-12 col-md-12">
                                 ...
                                 { 
                                                         ...
                                                         <td class="text-center" style="font-size:10px; width:85px;border-bottom:1px solid #333;"><?php echo $value['reciever_city']; ?></td>
                         ...
                         <!--<tr class="nodata"><td colspan="20">&nbsp;</td></tr>-->
                                                             ...
                                                             <?php  if($value['transportation_charges']!="" && $value['transportation_charges']!="0"){ ?>
                                                              ...
                                                              <?php  if($value['pickup_charges']!="" && $value['pickup_charges']!="0"){ ?>
                                                                  <tr><td style="font-size:10px;">PickupCh.:</td><td style="padding-right: 5px;font-size:10px;"><?php echo number_format((float)$value['pickup_charges'], 2, '.', ''); ?></td></tr>
                                                                  <?php  } ?>
                                                                    <?php  if($value['delivery_charges']!="" && $value['delivery_charges']!="0"){ ?>
                                                                  <tr><td style="font-size:10px;">Delivery:</td><td style="padding-right: 5px;font-size:10px;"><?php echo number_format((float)$value['delivery_charges'], 2, '.', ''); ?></td></tr>
                                                                  <?php  } ?>
                                                                    <?php  if($value['courier_charges']!="" && $value['courier_charges']!="0"){ ?>
                                                                  <tr><td style="font-size:10px;">Courier:</td><td style="padding-right: 5px;font-size:10px;"><?php echo number_format((float)$value['courier_charges'], 2, '.', ''); ?></td></tr>
                                                                  <?php  } ?>
                                                                   <?php  if($value['awb_charges']!="" && $value['awb_charges']!="0"){ ?>
                                                                  <tr><td style="font-size:10px;">AWB:</td><td style="padding-right: 5px;font-size:10px;"><?php echo number_format((float)$value['awb_charges'], 2, '.', ''); ?></td></tr>
                                                                  <?php  } ?>
                         ...
                         <tr class="border-bottom">
                                                         ...
                                                         <td colspan="4" class="extra-border" style="font-size:10px;padding: 10px;border:1px solid #333">
                                                           ...
                                                           <?php echo $company_details->bank_name; ?>,<?php echo $company_details->branch_name; ?><br>
                                                             ...
                                                             <td colspan="1" class=" text-right" style="font-size: 10px;padding: 10px; width:100px; border-top:1px solid #333;border-right:1px solid #333;">
                                                                 ...
                                                                 <b>Sub Total</b><br>
                                                                 <b>CGST <?php echo $gstCharges[0]['value']; ?>%</b><br>
                                                                 <b>SGST <?php echo $gstCharges[2]['value']; ?>%</b><br>
                                                                 <b>IGST&nbsp;<?php echo $gstCharges[1]['value']; ?>%</b><br>
                                                            ...
                                                            <td class="text-right" style="font-size: 11px;border-top:1px solid #333; width:100px; padding-right:10px;">
                                                                     <div><?php echo $sub_total; ?></div></br>
                                                                     <div><?php $cgst=$customer->cgst_amount; 
                                                                       echo $cgst?></br></br></div>
                                                                     <div><?php $sgst=$customer->sgst_amount; 
                                                                       echo $sgst?></br></br></div>
                                                                     <div><?php $igst=$customer->igst_amount; 
                                                                       echo $igst?></br></div>
                                                          <?php 
                                 ...
                                 <div style="border:1px solid #333; float:left; width:100%; font-size:10px;">
                                        ...
                                        <div style="float:right;width:30%;padding: 10px;">
                                            <div>For <?php echo $company_details->company_name;?></div> <br/><br/><br/><br/><br/><br/>
