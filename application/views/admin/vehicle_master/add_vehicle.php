                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="row">                                           
                                        <div class="col-12">
                                            <form role="form" action="<?php echo base_url();?>admin/add-vehicle" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-row">
													...
													<div class="col-3 mb-3">
													 ...
													 <div class="col-3 mb-3">
                                                        ...
                                                        <input type="text" name="vehicle_model" id="v_pincode" class="form-control" >
                                                    </div>
													<div class="col-3 mb-3">
                                                        <label for="username">Vehicle PUC Date</label>
														<input type="date" name="vehicle_puc_date" id="v_state" class="form-control" >
                                                    </div>
													<div class="col-3 mb-3">
                                                        <label for="username">Vehicle Fitness Exp Date</label>
														<input type="date" name="vehicle_fit_exp_date"  id="v_state" class="form-control" >
                                                    </div>
													<div class="col-3 mb-3">
                                                        <label for="username">Vehicle Permit Renewal Date</label>
														<input type="date" name="vehicle_per_renw_date"  id="v_state" class="form-control" >
                                                    </div>
													<div class="col-3 mb-3">
                                                        <label for="username">Vehicle Insurance Renw.</label>
														<input type="date" name="vehicle_insurance_renw" id="v_city" class="form-control" >
                                                    </div>
													<div class="col-3 mb-3">
                                                        <label for="username">Vehicle Capacity</label>
                                                        <input type="text" name="vehicle_capicity" class="form-control" >
                                                    </div>
