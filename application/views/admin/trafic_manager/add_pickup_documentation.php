                                ...
                                <div class="card p-4">
                                    <div class="card-body">
                                      ...
                                      <?php //print_r($ftl_id);?>
                                        ...
                                        <form action="<?php echo base_url("admin/upload-trip-documents/".$ftl_id['ftl_request_id']); ?>" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  class="form-control" name="ftl_id" value="<?php echo $ftl_id['ftl_request_id'] ?>" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
