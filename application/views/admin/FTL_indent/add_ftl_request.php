            ...
            <div class="card-body">
              ...
              <form action="<?php echo base_url(); ?>admin/add-ftl-request" enctype="multipart/form-data" method="POST">
                ...
                <div class="" style="margin-bottom:20px;color:#e95320;padding:10px;">
                  <h5 class="mb-0 text-uppercase font-weight-bold">Genrate Indent ( tripsheet )</h5>
                </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="hidden" name="ftl_request_id" class="form-control" value="<?php echo $FTTLR_id; ?>"
                        readonly>
                      <input type="text" name="order_date" id="current_date" value="<?php echo $date; ?>"
                  ...
                  <div class="form-group  col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="consignee_name" class="form-control" placeholder="Enter Name"
                        value="<?php echo set_value('consignor_name') ?>">
                    </div>
                  </div>
                  <div class="form-group  col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="consignee_address" placeholder="Enter Address" class="form-control"
                        value="<?php echo set_value('consignee_address') ?>">
                    </div>
                  </div>
                  <div class="form-group  col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="consignee_contact_no" maxlength="10" minlength="10"
                        ...
                        value="<?php echo set_value('consignee_contact_no') ?>">
                    </div>
                  </div>
                  <div class="form-group  col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="consignee_pincode" id="consignee_pincode" placeholder="Enter pincode"
                        ...
                        value="<?php echo set_value('consignee_pincode') ?>">
                    </div>
                  </div>
                  <div class="form-group  col-md-4">
                    <div class="form-group">
                  ...
                  <div class="form-group col-md-4 required">
                    <div class="form-group">
                      ...
                      <input type="text" name="origin_pincode" id="origin_pincode" maxlength="6" minlength="6"
                        class="form-control" value="<?php echo set_value('origin_pincode') ?>"
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="control-label">Origin City <span style="color:red;"><i class="fa fa-star"
                            aria-hidden="true"></i></span></label>
                      <select class="form-control fillter origin_city_id" id="origin_city_id" name="origin_city">
                        <option value="">Select City</option>
                        <?php
                        if (count($cities)) {
                          foreach ($cities as $c) { ?>
                  ...
                  <div class="form-group col-md-4 required">
                    <div class="form-group">
                      ...
                      <input type="text" id="destination_pincode" name="destination_pincode"
                        ...
                        value="<?php echo set_value('destination_pincode') ?>" placeholder="Enter Pincode" required="">
                    </div>
                  </div>
                  <div class="form-group col-md-4 required">
                    <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="control-label">Destination City <span style="color:red;"><i class="fa fa-star"
                            aria-hidden="true"></i></span></label>
                      <select class="form-control fillter destination_city_id" id="destination_city" name="destination_city">
                        <option value="">Select City</option>
                        <?php
                        if (count($cities)) {
                          foreach ($cities as $c) { ?>
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <label class="control-label">Pickup Address <span style="color:red;"><i class="fa fa-star"
                          aria-hidden="true"></i></span></label>
                    <textarea class="form-control" name="pickup_address" placeholder="Enter Pickup Location"></textarea>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="vehicle_body_type" id="vehicle_body_type"
                      placeholder="Vehicle body Type" required>
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control billing_amount" name="goods_weight" id="goods_weight"
                      placeholder="Enter Goods Weight" required>
                  </div>
                  <div class="form-group col-md-3">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control billing_amount" name="goods_value" id="goods_value"
                      placeholder="Enter Goods Value" required>
                  </div>
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" name="contact_number" value="<?php echo set_value('contact_number') ?>"
                      maxlength="10" minlength="10" class="form-control manifest_driver_contact" pattern='^\+?\d{0,10}'
                ...
                <div class="row">
                  <div class="form-group col-md-3">
                    <label class="control-label">Delivery Contact No <span style="color:red;"><i class="fa fa-star"
                          aria-hidden="true"></i></span></label>
                    <input type="text" name="delivery_contact_no" value="<?php echo set_value('delivery_contact_no') ?>"
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" name="delivery_contact_person_name"
                      value="<?php echo set_value('delivery_contact_person_name') ?>" class="form-control"
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <textarea type="text" col="100" name="descrption" class="form-control"
                      placeholder="Special Instruction" row="10"></textarea>
                  </div>
