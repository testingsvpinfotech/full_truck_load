     					...
     					<div class="col-12 col-sm-12 mt-3">
     						<div class="card">
     							<div class="card-header justify-content-between align-items-center">
     								<h4 class="card-title">Genrate Bag</h4>
     							</div>
     							<div class="card-body">
     								...
     								<div class="row">
     									<div class="col-12"> 
											<a href="<?= base_url('admin/view-genrated-bag'); ?>" class="btn btn-primary">View Genrated Bag</a> <br><br>
     										<form role="form" action="<?= base_url(); ?>admin/bag-genrate" method="post" enctype="multipart/form-data">
     											<div class="form-group row">
												 <label class="col-sm-1 col-form-label">Menifest</label>
     												<div class="col-sm-2">
     													<input type="text" name="menifest" id="awb" class="form-control" />
     												</div>
     										...
     										<form role="form" action="<?= base_url('admin/add-bag'); ?>" method="post" enctype="multipart/form-data">
     											<div class="form-group row">

     												<label class="col-sm-2 col-form-label">Bag Genrate Date</label>
     												<div class="col-sm-2">
     													...
     													<?php
															...
															// $datec = str_replace(' ', 'T', $datec);
															?>
     													<input type="datetime-local" required class="form-control" readonly name="datetime" value="<?php echo $datec; ?>" id="col-sm-1 col-form-label">
     												</div>
     											...
     											<div class="form-group row">
     												...
     												<label class="col-sm-2 col-form-label">Select Bag</label>
     												<div class="col-sm-2">
     													<select name="bag" class="form-control" id="destination_branch" required>
     														<option>Select Bag</option>
     														<?php foreach ($bag as $value) {
																?>
     															<option value="<?php echo $value->bag_type; ?>"><?php echo $value->bag_type; ?></option>
     														<?php
																} ?>
     													</select>
     												</div>
