                    ...
                    <form action="<?php echo base_url(); ?>admin/add-ftl-request" enctype="multipart/form-data" method="POST">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-3">
                          <select name="customer_type" id="customer" class="form-control" style="margin-top: 26px;border: 1px solid rgb(255 255 255 / 80%) !IMPORTANT;" required>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="hidden" name="origin_city" id="origin_city_id" value="<?php echo set_value('origin_city') ?>" class="form-control origin_city_id" required>
                        ...
                        <div class="col-md-1 mt-3">
                          <div class="form-group">
                            ...
                            <input type="hidden" name="destination_city_id" id="destination_city_id" value="" class="form-control destination_city_id" required readonly>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <hr>
                      ...
                      <div class="row">
                        <div class="form-group col-md-6">
                          ...
                          <input class="form-control" name="pickup_address" type="text" placeholder="Enter Pickup Location">
                        </div>

                        <div class="form-group col-md-6">
                          <label class="control-label">Delivery Address <span style="color:red;"><i class="fa fa-star" aria-hidden="true"></i></span></label>
                          <input type="text" class="form-control" name="delivery_address" placeholder="Enter Delivery Location">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group ">
                            <label class="control-label">Type Of vehicle  <span style="color:red;"><i class="fa fa-star" aria-hidden="true"></i></label>
                            <select class="form-control get_vehical_type" id="vehicle_id" name="type_of_vehicle" required>
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <input type="text" class="form-control" name="vehicle_body_type" id="vehicle_body_type" required>
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <input type="text" name="amount" id="target_rate" class="form-control target_rate" value="" placeholder="Enter Amount" required>
                          </div>
