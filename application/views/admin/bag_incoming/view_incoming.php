 ...
 <span style="float: right;"><a href="admin/add-incoming-bag" class="fa fa-plus btn btn-primary">Add Incoming Bag</a></span>							  
                          </div>
                          <div class="card-body">
                  ...
                  <td><?php echo $value['total_weight'];?></td>
                   ...
                   <td><a href="admin/add-incoming-bag/<?php echo $value['bag_no'];?>"><i class="ion-edit" style="color:var(--primarycolor)"></i></a></td>
				</tr>
					<?php 
					$cnt++;
							  }
