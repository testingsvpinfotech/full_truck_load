                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">                               
                              <h4 class="card-title">Update Status International Shipment</h4>
                          </div>
                          <div class="card-body">
                            <div class="row">                                           
                          <div class="col-12">
                              <form role="form" action="<?php echo base_url(); ?>admin/view-international-delivery-status" method="post" autocomplete="off">
                                             <div class="form-row">
												<div class="col-md-2">
                                ...
                                ?>
                                    <div class="form-row">
                                           <div class="row" id="div_transfer_rate" style="display:none;" >   
                                                <div class="col-12">                            
                                                  <form role="form" action="admin/change-international-delivery-status" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <h6><b>Change Delivery Status</b><a href="" onclick="return hide_transfer_div()"  ><i class="ion-close-circled"></i></a></h6>              
                                                     <div class="form-group row">  
                                                          ...
                                                          <label class="col-sm-1">Baranch Name</label>
