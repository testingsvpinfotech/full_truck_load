    ...
    <div class="section-full dez-we-find bg-img-fix m-t50 p-b50" style="margin-top: 70px;">
        <div class="container">
            <div class="section-content">
                <div class="row ">
                    <h3 class="form-title m-t0" style="color: #e8501c;padding: 20px;">Approve Quotation List </h3>
                    <div class="col-md-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if ($value['ftl_booking_status'] == '1') { ?>
                                                    ...
                                                    <a href="<?php echo base_url('upload-pod/' . $value['ftl_request_id']); ?>" class="btn btn-info">Upload Pod</a>
