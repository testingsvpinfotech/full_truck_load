                        ...
                        <div class="card-body">
                            <div class="col-12 col-md-12 mt-3">
                                <div class="card p-4">
                                    <div class="card-body">
                                        <?php print_r($update);?>
                                        <form action="<?php echo base_url()."User_panel/update_goods_type/".$update['id'] ;?>" enctype="multipart/form-data" method="POST">
                                            <div class="" style="margin-bottom:20px; background-color:#1e3d5d;color:#fff;padding:10px;">
                                                <h6 class="mb-0 text-uppercase font-weight-bold">Update Goods Type</h6>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Goods Name</label>
                                                        <input type="text" name="goods_name" value="<?php echo $update['goods_name'];?>" placeholder="Enter Goods Name" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
