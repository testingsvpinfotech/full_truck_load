  ...
  <td class="td-nospace">
    <table style="width:100%; min-width: 250px " border="0" class="border-none" >
      ...
      <tr>
        ...
        <h1 style="margin-top:5px;margin-bottom:5px;"><?php echo $value['pod_no'];?></h1>
...
<tr>
  <td class="td-nospace">
      <p style="font-size:9px;">I/we hereby authorize M/S.<?php echo $company_details->company_name;?>, its associate/principals and its affiliates to act as our agent and do all acts necessary on our behalf including to file all documents declaration for customers for export on courier or freight mode.I/We agree to the terms of M/S. <?php echo $company_details->company_name;?> as follows:
