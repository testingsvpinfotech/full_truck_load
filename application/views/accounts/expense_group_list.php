                ...
                <div class="offset-md-2 col-md-8 col-sm-12 mt-2">
                    <div class="box">
                        <div class="box-header justify-content-between align-items-center">
                            ...
                            <button class="btn btn-sm btn-primary" onclick="openexpGrpModal()"> Add New</button>
                                ...
                                <table class="table layout-primary table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <!-- <th scope="col">Nature of Group</th> -->
                                            <th scope="col">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tableData">
                                        <?php if(!empty($expGrpData)): foreach ($expGrpData as $value): ?>
                                        <tr>
                                            <td><?= $value->name; ?></td>
                                            <!-- <td><?= ($value->group_type==1)?"Primary":""; ?></td> -->
                                            <!-- <td><?= ($value->group_type == 0)?"":$nature[$value->group_type]; ?></td> -->
                                            <td>
                                                <a onclick="openexpGrpModal(<?= $value->id; ?>)"><i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
