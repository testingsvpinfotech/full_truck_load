...
<table width="1000" border="1">
  <tbody>
    ...
    <tr>
      ...
      <td rowspan="7"  valign="top" style="border: none;">Transportation Charges<br/><br/><input type="text" value="<?php echo $charges[0]['product_name'] ;?>"></td>
    ...
    <tr>
      ...
      <td rowspan="4"><strong>Account Details:<br>
...
<table width="1000" border="1">
  <tbody>
    <tr>
      <td width="359" colspan="3"><strong>Amount Chargeable (in words) : <?php if($charges[0]['grand_total']>0){ echo ucwords(displaywords(round($charges[0]['grand_total'], 0))); }else{ echo  ''; } ?></strong></td>
    </tr>
  </tbody>
</table>
<table width="1000" border="1">
  <tbody>
    <tr>
      <td width="359" colspan="3"><strong>Tax Amount (in words) : <?php if($charges[0]['gst_charge']>0){ echo ucwords(displaywords(round($charges[0]['gst_charge'], 0))); }else{ echo  ''; } ?></strong></td>
    </tr>
  </tbody>
</table>
<table width="1000" border="0">
