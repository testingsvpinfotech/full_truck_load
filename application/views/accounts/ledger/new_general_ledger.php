                            ...
                            <div class="row">
                                <div class="col-md-6">
                                            <div class="form-row">
                                                ...
                                                <div class="col-4 mb-3">
                                                    <label>Under</label>
                                                    <select type="text" class="form-control" name="under_group" id="under_group">
                                                ...
                                                <div class="col-4 mb-3">
                                                    <label for="">Type of Ledger </label>
                                                ...
                                                <div class="col-4 mb-3">
                                                    <label for="username">Set Gst Details</label>
                                                ...
                                                <div class="col-4 mb-3">
                                                    <label for="email">Type of Supply</label>
                                                ...
                                                <div class="col-4 mb-3">
                                                    <label for="email">Is Tds Applicable</label>
                                                    <select class="form-control" name="is_tds_applicable" id="is_tds_applicable">
                                                ...
                                                <div class="col-4 mb-3">
                                                    ...
                                                    <select class="form-control" name="nature_of_payment" id="nature_of_payment">
                                                        <option value="">Please select</option>
                                                        <?php if (!empty($payment)) { foreach ($payment as $v) {
